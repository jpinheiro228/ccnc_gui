...
class MyWindow(Gtk.Window):
    def __init__(self):
        ...
        self.commandGrid = Gtk.Grid()
        self.commandGrid.set_column_spacing(5)
        self.commandGrid.set_row_spacing(5)
        self.commandGrid.set_column_homogeneous(True)
        self.commandGrid.attach(self.button1, 1, 1, 1, 1)
        self.commandGrid.attach(self.button2, 2, 1, 1, 1)
        self.commandGrid.attach(self.button3, 1, 2, 2, 1)
        ...
        self.saturationGrid = Gtk.Grid()
        self.saturationGrid.set_column_spacing(5)
        self.saturationGrid.set_row_spacing(5)
        self.saturationGrid.set_column_homogeneous(True)
        ...
        self.measurementsGrid = Gtk.Grid()
        self.measurementsGrid.set_column_spacing(5)
        self.measurementsGrid.set_row_spacing(5)
        ...
        self.grid.attach_next_to(sibling=self.saturationFrame, child=self.commandFrame, side=BOTTOM, width=1, height=1)
